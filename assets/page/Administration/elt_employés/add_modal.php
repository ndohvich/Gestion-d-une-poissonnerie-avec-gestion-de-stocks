    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <center><h4 class="modal-title" id="myModalLabel">Ajouter un employé</h4></center>
            </div>
            <div class="modal-body">
			<div class="container-fluid">
			<form method="POST" action="elt_employés/add.php">
				<div class="row form-group">
					<div class="col-sm-2">
						<label class="control-label modal-label">Avatar :</label>
					</div>
					<div class="col-sm-10">
					<input class="form-control" type="file" name="avatar" for="avatar" id="avatar" required>
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-2">
